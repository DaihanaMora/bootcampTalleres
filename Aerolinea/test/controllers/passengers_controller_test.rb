...
class PassengersControllerTest < ActionController::TestCase
  ...
  test "should create passenger" do
    assert_difference('Passenger.count') do
      post :create, passenger: { identificacion: @passenger.identificacion, nombre: @passenger.nombre, vuelo_id: @passenger.vuelo_id }
    end
  ...
  test "should update passenger" do
    patch :update, id: @passenger, passenger: { identificacion: @passenger.identificacion, nombre: @passenger.nombre, vuelo_id: @passenger.vuelo_id }
    assert_redirected_to passenger_path(assigns(:passenger))
  end
