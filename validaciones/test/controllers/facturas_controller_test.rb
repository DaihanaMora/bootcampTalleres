...
class FacturasControllerTest < ActionController::TestCase
  ...
  test "should create factura" do
    assert_difference('Factura.count') do
      post :create, factura: { cliente: @factura.cliente, descripcion: @factura.descripcion, precio: @factura.precio, total: @factura.total }
    end
  ...
  test "should update factura" do
    patch :update, id: @factura, factura: { cliente: @factura.cliente, descripcion: @factura.descripcion, precio: @factura.precio, total: @factura.total }
    assert_redirected_to factura_path(assigns(:factura))
  end
